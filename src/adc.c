...
// DESCRIPTION   : The function configures the ADC3 and GPIOB and reads the
//                 ADC Value 
...
ADD_CMD("adc3", CmdADC3, "		The ADC3 value");
